...
<html>
	...
	<body>
		...
		<div class="text-center">
			...
			<a href="manager_information.php" class="btn btn-warning">Manager information</a>
			<a href="customer_information.php" class="btn btn-primary">Customer information</a>
			<a href="employe_information.php" class="btn btn-warning">Employe Information </a>
           ...
           <!-- <a href="generate_sales_report.php" class="btn btn-info">Generate Sales Report </a>	
            <a href="add_employee.php" class="btn btn-info">Add employee</a> 
